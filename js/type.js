...
const typedata = {
    1: {
        ...
        operas: [
            {
                title: "群英会·借东风",
                image: "./images/opera/jing1.png",
                description: "讲述了三国时期，诸葛亮在赤壁之战中利用周瑜的计谋，借得东风，成功实施火攻，大败曹操的故事"
            },
            {
                title: "四进士",
                image: "./images/opera/jing2.png",
                description: "讲述了明朝四位进士因正义感而卷入一桩冤案，并最终合力为无辜者申冤昭雪的故事"
            },
            {
                title: "霸王别姬",
                image: "./images/opera/jing3.png",
                description: "讲述了楚汉相争时期，西楚霸王项羽在垓下被围，与爱妃虞姬诀别，最终虞姬自刎，项羽战败自刎的悲壮爱情故事"
            },
            {
                title: "棋盘山",
                image: "./images/opera/jing4.png",
                description: "讲述了薛丁山与窦仙娘在棋盘山上因误会交战、后结为夫妻并共同抗敌的故事"
            },
            {
                title: "挑滑车",
                image: "./images/opera/jing5.png",
                description: "描绘了岳飞帐下猛将高宠挑滑车、力战金兵的英勇事迹"
            },
            {
                title: "八大锤",
                image: "./images/opera/jing6.png",
                description: "讲述了岳飞之子岳云与另外三位锤将共同迎战敌军，大败金兀术的故事"
            }
        ]
    },
    2: {
        title: "越剧",
        image: "./images/yue2.png",
        ...
        operas: [
            {
                title: "孟丽君",
                image: "./images/opera/yue1.png",
                description: "讲述了孟丽君为救被诬陷的父亲，女扮男装中试成为丞相，最终揭露奸臣阴谋，与爱人皇甫少华成婚的故事"
            },
            {
                title: "西厢记",
                image: "./images/opera/yue2.png",
                description: "讲述了书生张生与相国小姐崔莺莺在丫环红娘的帮助下，冲破封建礼教束缚，终成眷属的爱情故事"
            },
            {
                title: "五女拜寿",
                image: "./images/opera/yue3.png",
                description: "讲述了杨继康因得罪严嵩被革职抄家，五个女儿中只有养女三春夫妇收留他，最终三春丈夫邹应龙扳倒严嵩，杨家冤案昭雪的故事"
            },
            {
                title: "珍珠塔",
                image: "./images/opera/yue4.png",
                description: "讲述了方卿家道中落遭姑母奚落，表姐暗赠珍珠塔，中试封官后表姐完婚的故事"
            },
            {
                title: "碧玉簪",
                image: "./images/opera/yue5.png",
                description: "讲述李秀英被陷害，真相大白后夫妻和解的故事"
            },
            {
                title: "祥林嫂",
                image: "./images/opera/yue6.png",
                description: "讲述祥林嫂屡遭不幸，最终在风雪中倒毙的悲剧故事"
            }
        ]
    },
    3: {
        title: "黄梅戏",
        image: "./images/huang2.png",
        ...
        operas: [
            {
                title: "天仙记",
                image: "./images/opera/huang1.png",
                description: "讲述了七仙女下凡与董永相爱并结为夫妻，但最终被迫分离的凄美爱情故事"
            },
            {
                title: "女驸马",
                image: "./images/opera/huang2.png",
                description: "讲述了才女冯素珍女扮男装考取状元并成为驸马，最终与心爱之人终成眷属的故事"
            },
            {
                title: "桃花扇",
                image: "./images/opera/huang3.png",
                description: "讲述了明末歌女李香君与才子侯方域在动荡时代的爱情悲剧"
            },
            {
                title: "打猪草",
                image: "./images/opera/huang4.png",
                description: "讲述了乡村少女陶金花与少年金小毛在打猪草时相遇、相识并萌生爱情的故事"
            },
            {
                title: "梁祝",
                image: "./images/opera/huang5.png",
                description: "讲述了梁山伯与祝英台之间跨越生死的凄美爱情故事"
            },
            {
                title: "夫妻观灯",
                image: "./images/opera/huang6.png",
                description: "以幽默诙谐的方式讲述了一对夫妻元宵节观灯时的趣事和误会"
            }
        ]
    },
    4: {
        ...
        operas: [
            {
                title: "杨三姐告状",
                image: "./images/opera/ping1.png",
                description: "讲述了杨三姐为姐伸冤，历尽艰辛，最终揭露真相、将凶手绳之以法的故事"
            },
            {
                title: "杜十娘",
                image: "./images/opera/ping2.png",
                description: "讲述了红十娘反抗封建压迫，追求自由和爱情，最终与爱人共同反抗恶霸的故事"
            },
            {
                title: "刘巧儿",
                image: "./images/opera/ping3.png",
                description: "讲述了农村少女刘巧儿反抗封建包办婚姻、争取婚姻自由，并最终与心上人相爱结合的故事"
            },
            {
                title: "桃花庵",
                image: "./images/opera/ping4.png",
                description: "讲述了尼姑陈妙常与书生潘必正之间的爱情故事"
            },
            {
                title: "小女婿",
                image: "./images/opera/ping5.png",
                description: "讲述了少女杨香草反抗封建包办婚姻，追求自由恋爱的故事"
            },
            {
                title: "马寡妇开店",
                image: "./images/opera/ping6.png",
                description: "讲述了马寡妇在开店过程中与秀才狄仁杰相识并最终结为夫妻的故事"
            }
        ]
    },
    5: {
        ...
        operas: [
            {
                title: "秦香莲",
                image: "./images/opera/yu1.png",
                description: "讲述了秦香莲在丈夫陈世美高中状元后被抛弃，历尽艰辛最终伸张正义的故事"
            },
            {
                title: "小二黑结婚",
                image: "./images/opera/yu2.png",
                description: "讲述了农村青年小二黑与小芹自由恋爱，冲破封建束缚，最终幸福结合的故事"
            },
            {
                title: "花木兰",
                image: "./images/opera/yu3.png",
                description: "讲述了花木兰女扮男装代父从军，历经沙场征战，最终胜利归来并恢复女儿身的故事"
            },
            {
                title: "朝阳沟",
                image: "./images/opera/yu4.png",
                description: "讲述了城市青年响应号召下乡插队，经历思想和生活挑战后，最终融入农村生活的故事"
            },
            {
                title: "抬花轿",
                image: "./images/opera/yu5.png",
                description: "讲述了新科文状元周进宝在姐姐周凤莲的婚礼上意外重逢已故定情妻子王定云，最终在姐姐的帮助下克服门第障碍，与王定云重归于好的故事"
            },
            {
                title: "穆桂英挂帅",
                image: "./images/opera/yu6.png",
                description: "讲述了穆桂英在国家危难之际，放下个人恩怨，重新披挂上阵，带领杨家将奋勇抗敌的故事"
            }
        ]
    }
};
